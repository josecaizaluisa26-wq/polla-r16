...
const MATCHES_R16 = [
  ['R16_1','Sudáfrica','Canadá'],
  ['R16_2','Brasil','Japón'],
  ['R16_3','Alemania','Paraguay'],
  ['R16_4','Países Bajos','Marruecos'],
  ['R16_5','Costa de Marfil','Noruega'],
  ['R16_6','Francia','Suecia'],
  ['R16_7','México','Ecuador'],
  ['R16_8','Estados Unidos','Bosnia'],
  ['R16_9','Bélgica','Senegal'],
  ['R16_10','Inglaterra','Rep. D. Congo'],
  ['R16_11','Colombia','Croacia'],
  ['R16_12','España','Austria'],
  ['R16_13','Suiza','Argelia'],
  ['R16_14','Argentina','Cabo Verde'],
  ['R16_15','Australia','Egipto'],
  ['R16_16','Portugal','Ghana'],
